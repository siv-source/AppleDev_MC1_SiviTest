...
extension ContentString{
    ...
    [   //question 1
        ContentString(question:"당신은 어떻게 행동하겠는가?",
                    answers: [
                        Answer(state: "어색한 건 싫어! 말을 먼저 건다.", score: [1,0,0,0,0,0]),
                        Answer(state: "시간이 지나면 자연스럽게 친해질 테니 그냥 있는다.", score: [0,1,0,0,0,0]),
      ...
      ContentString(question:"당신은 어떻게 행동하겠는가?",
                    answers: [
                        ...
                        Answer(state: "누구와 가도 상관없어!\n 바로 인터뷰할 사람을 물색!", score: [0,1,0,0,0,0]),
                        Answer(state: "말을 거는 건 어려워! \n 친화력이 좋은 팀원과 함께 간다.", score: [0,0,1,0,0,0]),
                        Answer(state: "새로운 사람에게 말 거는 것을 어려워하는 팀원이 있는지 물어보고, 함께 하자고 한다.", score: [0,0,0,1,0,0])
                    ]),
        //question 3
      ContentString(question:"당신의 역할은?",
                    answers: [
                        Answer(state: "막히거나 논지를 벗어날 때, 정리하고 보강하기", score: [1,0,0,0,0,0]),
                        Answer(state: "이건 어떨까? 새로운 방향과 아이디어 제시하기", score: [0,0,1,0,0,0]),
                        Answer(state: "우리 팀원들 대단해~좋아요~ 긍정 리액션 담당! 공감하고 칭찬하기!", score: [0,1,0,0,0,0]),
                    ]),
        //question 4
      ContentString(question:"당신의 반응은?",
                    answers: [
                        Answer(state: "우리 아이디어는 괜찮은 것 같은데... \n 다음 발표는 제대로 해야겠군!", score: [1,0,0,0,0,0]),
                        Answer(state: "지적받은 것에 시무룩해진 것도 잠시, \n 피드백에 따라 자료를 바로 보강한다.", score: [0,1,0,0,0,0]),
                        Answer(state: "우리팀 수고했어요~다음에 잘하면 되죠! \n 일단 긍정적인 마인드를 되찾는다.", score: [0,0,1,0,0,0]),
                    ]),
        //question 5
      ContentString(question:"밥을 먹으며 당신은 무슨 생각 중..?",
                    answers: [
                        Answer(state: "요즘 물가가 많이 올랐군,,,", score: [1,0,0,0,0,0]),
                        Answer(state: "밥먹고는 있지만, 프로젝트에 대한 생각을 계속한다", score: [0,1,0,0,0,0]),
      ...
      ContentString(question:"당신은 어떻게 할 것인가?",
                    answers: [
                        ...
                        Answer(state: "우리 팀 말만 해! 팀원들의 의견을 최대한 반영한다.", score: [0,0,0,0,1,0]),
        ...
        ContentString(question:"당신이 생각하는 첫 MC1의 가치는?",
                      answers: [
                        ...
                        Answer(state: "앞으로의 아카데미에서 열심히 활동할 수 있는 용기와 자극제!", score: [1,0,0,0,0,0]),
